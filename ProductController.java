...
import com.springbackend.Springbackend.service.ProductService;
...
//http://localhost:8080/api/v1/getAllProducts
	...
	// http://localhost:8080/api/v1/getProduct/1
	...
	//http://localhost:8080/api/v1/deleteProduct/1
		...
		public ResponseEntity<String> deleteProduct(@PathVariable("productId") int proId) {
