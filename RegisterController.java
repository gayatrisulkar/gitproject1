...
import com.springbackend.Springbackend.service.RegisterService;
...
//http://localhost:8080/api/v1/getAllRegisters
	...
	@GetMapping("/getRegister/{registerId}")
	public ResponseEntity<Register> getRegisterById(@PathVariable("registerId") int registerId)
	...
	//http://localhost:8080/api/v1/deleteRegister/1
		@DeleteMapping(value = "/deleteRegister/{registerId}")
		public ResponseEntity<String> deleteRegister(@PathVariable("registerId") int regId) {
